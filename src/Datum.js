...
module.exports = class Datum {
    ...
    createAddRequestTransaction(address_from, category, price, duration) {
        return this.getNewRawTranscation(address_from)
            .then(tx => {
                var data = this.marketplaceContract.methods.addRequest(category, price, duration).encodeABI();
                tx.to = marketplaceContractAddress;
                tx.data = data;
                tx.value = '0x0';
                return tx;
    ...
    createCancelRequestTransaction(address_from, id) {
        return this.getNewRawTranscation(address_from)
            .then(tx => {
                var data = this.marketplaceContract.methods.cancelRequest(id).encodeABI();
                tx.to = marketplaceContractAddress;
                tx.data = data;
                tx.value = '0x0';
                return tx;
    ...
    createDepositTransaction(address_from, amount) {
        return this.getNewRawTranscation(address_from)
            .then(tx => {
                tx.to = marketplaceContractAddress;
    ...
    createWithdrawalTransaction(address_from, amount) {
        return this.getNewRawTranscation(address_from)
            .then(tx => {
                var data = this.marketplaceContract.methods.withdrawal(amount).encodeABI();
                tx.to = marketplaceContractAddress;
                tx.data = data;
                tx.value = '0x0';
                return tx;
    ...
    createAuctionBidTransaction(address_from, id, amount) {
        return this.getNewRawTranscation(address_from)
            .then(tx => {
                var data = this.marketplaceContract.methods.bid(id, amount).encodeABI();
                tx.to = marketplaceContractAddress;
                tx.data = data;
                tx.value = '0x0';
                return tx;
    ...
    createAuctionCloseTransaction(address_from, id) {
        return this.getNewRawTranscation(address_from)
            .then(tx => {
                var data = this.marketplaceContract.methods.closeAuction(id).encodeABI();
                tx.to = marketplaceContractAddress;
                tx.data = data;
                tx.value = '0x0';
                return tx;
