...
Datum.prototype.addClaim = function (subject, key, value, password = null) {
    ...
    let keyEncoded = web3Static.eth.abi.encodeParameter('bytes32', web3Static.utils.fromAscii(key));
    let valueEncoded = web3Static.eth.abi.encodeParameter('bytes32', web3Static.utils.fromAscii(value));
