...
Datum.prototype.addClaim = function (subject, key, value, password = null) {
    ...
    return this.identity.signMsgHash(fixed_msg_sha).then(signature => {
        var data = TxDataProvider.getAddClaimDataForStorageAddress(subject, key, value, fixed_msg_sha, signature.v, "0x" + signature.r.toString("hex"), "0x" + signature.s.toString("hex"));
