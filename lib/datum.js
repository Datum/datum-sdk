 ...
 * @return {Promise}
 */
Datum.prototype.addClaimWithSigner = function (subject, key, value, fixed_msg_sha, signature, password = null) {
    validateClaimParameterType(key);

    var data = TxDataProvider.getAddClaimWithSignerData(subject, key, value, fixed_msg_sha, signature.v, "0x" + signature.r.toString("hex"), "0x" + signature.s.toString("hex"));
    var to = this.settings.contracts.registryContractAddress;
    return this.web3Manager.send(to, data);
};
