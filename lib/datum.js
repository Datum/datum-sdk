 ...
 * @return {Promise}
 */
Datum.prototype.removeClaimWithSigner = function (subject, key, signature) {
    validateClaimParameterType(key);

    var data = TxDataProvider.getRemoveClaimWithSignerData(subject, key, value, signature.v, "0x" + signature.r.toString("hex"), "0x" + signature.s.toString("hex"));
    var to = this.settings.contracts.registryContractAddress;
    return this.web3Manager.send(to, data);
};
