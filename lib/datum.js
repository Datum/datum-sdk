...
Datum.prototype.get = function (id) {
    ...
    return storageContract.methods.getNodesForItem(id).call().then(nodes => {
        ...
        return Promise.all([
            this.storage.postCustomStorageNode("https://" + results[0], "/v1/storage/download", postParams),
            this.storage.postCustomStorageNode("https://" + results[0], "/v1/storage/downloadHeader", postParams)]);
    }).then(results => {
