 ...
 * @return {Promise}
 */
Datum.prototype.addClaim = function (issuer, subject, value, password = null) {
    var data = TxDataProvider.getAddClaimData(issuer, subject, value);
...
/**
 * Withdrawal DAT tokens to owner address
 *
 * @method withdrawal
...
Datum.prototype.withdrawal = function (amount) {
    var data = TxDataProvider.getStorageWithdrawalData(this.web3Manager.toWei(amount.toString()));
    var to = this.identity.address;
    return this.web3Manager.send(to, data);
};
