...
var Web3Manager = function (httpProvider, privateKey, developerPublicKey) {
...
Web3Manager.prototype.sign = function (data) {
 ...
 Web3Manager.prototype.getNonce = function () {
    return this.web3.eth.getTransactionCount(this.publicAddress, "pending");
 };


 Web3Manager.prototype.getNonceCB = function (cb) {
    return this.web3.eth.getTransactionCount(this.publicAddress, "pending", function(error, result) {
       cb(result);
    });
 };

 Web3Manager.prototype.getBalance = function () {
    return this.web3.eth.getBalance(this.publicAddress);
 };

 Web3Manager.prototype.getBalanceForAddress = function (address) {
