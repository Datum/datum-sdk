...
TxDataProvider.getAddClaimDataForStorageAddress = function (subject, key, storageAddress, msgHash, v, r, s) {
    let types = ['address', 'bytes32', 'address','bytes32','uint8','bytes32','bytes32'];
    let params = [subject, key, value, msgHash, v,r,s];
    return enc('setClaim', types, params);
};
