...
StorageManager.prototype.initStorage = function (data, key, category, replicationMode, pricacyLevel, duration, metadata) {
    ...
    return this.web3.getNonce()
        .then(nonce => {
            ...
            //fire event
            self._events.emit("beforeSignTransaction", dataTransactions);
            ...
            self._events.emit("afterSignTransaction", signedSerializedTx.toString('hex'));
...
StorageManager.prototype.delete = function (id) {
    return new Promise((resolve, reject) => {
        try {
            ...
            console.log(this.endpoint + '/v1/storage/remove');
